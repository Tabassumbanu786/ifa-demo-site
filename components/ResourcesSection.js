  ...
  <FinanceNews />
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="/calculators/sip" className="bg-yellow-400 text-gray-900 font-medium px-6 py-3 rounded hover:bg-yellow-500">SIP Calculator</a>
            <a href="/calculators/emi" className="bg-yellow-400 text-gray-900 font-medium px-6 py-3 rounded hover:bg-yellow-500">EMI Calculator</a>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <ul className="list-disc pl-5 text-gray-700 space-y-2">
            <li><a href="/resources/goal-planner.pdf" target="_blank" className="text-blue-600 hover:underline">Goal Planner PDF</a></li>
            <li><a href="/resources/expense-tracker.xlsx" target="_blank" className="text-blue-600 hover:underline">Expense Tracker Excel</a></li>
            <li><a href="/resources/sip-planner.xlsx" target="_blank" className="text-blue-600 hover:underline">Simple SIP Planner Sheet</a></li>
          </ul>
        </div>
